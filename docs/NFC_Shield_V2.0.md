...
<table>
    <tr>
        <td>
            <img src="/assets/NFC_Shield_V2.0/img/NFC_front.png">
        </td>
        <td>
            <img src="/assets/NFC_Shield_V2.0/img/NFC_back.png">
        </td>
    </tr>
</table>
...
[![](/assets/common/Get_One_Now_Banner.png)](https://www.seeedstudio.com/NFC-Shield-V2.0-p-1370.html)
...
![](/assets/NFC_Shield_V2.0/img/Seeed-recipe-paper_man.jpg)
...
![](/assets/NFC_Shield_V2.0/img/Pn532-nfc-shield-pin-description.png)
...
![](/assets/NFC_Shield_V2.0/img/NFC_Antanna_28x30.5.jpg)
...
![](/assets/NFC_Shield_V2.0/img/Ndef-and-pn532-libraries-installed-in-arduino-ide.png)
...
![](/assets/NFC_Shield_V2.0/img/Nfc-pn532-output-example-1.png)
...
3.  Optional Step – connect a red LED to pin 4 as shown in the figure/schematic below. We'll use this LED to signal a mismatched key.
    ![](/assets/NFC_Shield_V2.0/img/Example-2-red-green-led-nfc-alarm.PNG)

    **NFC lock circuit**

    ![](/assets/NFC_Shield_V2.0/img/Example-2-red-green-led-nfc-alarm-real.png)
...
![](/assets/NFC_Shield_V2.0/img/Example-3-nfc-pn532-shield-interrupt-example.png)
...
![](/assets/NFC_Shield_V2.0/img/Example-4-write-ndef-message-to-tag.png)
...
![](/assets/NFC_Shield_V2.0/img/Example-5-format-nfc-tag-as-ndef.png)
...
![](/assets/NFC_Shield_V2.0/img/Example-6-read-ndef-message.png)
...
- [NFC Shield v2.0 Schematic](/assets/NFC_Shield_V2.0/res/NFC_Shield_Schematic.pdf)
- [NFC Shield v2.0 Eagle File](/assets/NFC_Shield_V2.0/res/NFC_Shield_V2.0b_Eagle_files.zip)
- [NFC Shield v2.1 Schematic](/assets/NFC_Shield_V2.0/res/NFC_Shield_v2.1.pdf)
- [NFC Shield v2.1 Eagle File](/assets/NFC_Shield_V2.0/res/NFC_Shield_v2.1_Eagle_File.zip)
- [PN532_SPI Library For NFC Shield v2.0](https://github.com/Seeed-Studio/PN532)
- [PN532 Datasheet](/assets/NFC_Shield_V2.0/res/PN532.pdf)
