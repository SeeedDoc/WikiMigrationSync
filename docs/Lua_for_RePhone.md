...
![](/assets/Lua_for_RePhone/img/Xadow_GSMPlusBLE_pingguo.JPG)
...
[![](/assets/Lua_for_RePhone/img/Download_Lua_for_RePhone.png)](https://github.com/Seeed-Studio/Lua_for_RePhone/releases)

**Step 2.** Click ***lua_for_rephone_xxx.zip*** to download

![](/assets/Lua_for_RePhone/img/Lua_for_rephone_download.png)

**Step 3.** Set your RePhone into storage mode by **plugging in the battery** and connect it to PC with a Micro USB cable.

![](/assets/Lua_for_RePhone/img/Connect_Xadow_GSMPlusBLE_to_PC.png)
...
![](/assets/Lua_for_RePhone/img/Lua_1.png)
...
![](/assets/Lua_for_RePhone/img/Check_ports.png)
...
![](/assets/Lua_for_RePhone/img/Putty_EOL.png)
...
![](/assets/Lua_for_RePhone/img/RePhone_Lua_Shell.png)
...
[![](/assets/Lua_for_RePhone/img/RePhone_Community-2.png)](http://www.seeedstudio.com/forum/viewforum.php?f=71&sid=b70f8138c89becf7701260bb41faf9f4)
