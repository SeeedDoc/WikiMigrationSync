...
![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/Music_Shield_Picture.jpg)
...
[![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/common/Get_One_Now_Banner.png)](http://www.seeedstudio.com/depot/Music-Shield-V20-p-1372.html)

Hardware Overview
-----------------

![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/Music_shield_frame.jpg)
...
![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/Music_shield4.jpg)
...
1. Restart the Arduino IDE. Open “creatList” example via the path: File --> Examples --> MusicPlayer --> creatList as below.
    ...
    ![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/OpenCreatListCode.jpg) 
...
2. Set the play mode. In “creatList”, the function we use is described as follows.
    ...
    **   Function:** Set the play mode. There are four modes you can set: MODE_NORMAL, MODE_SHUFFLE, MODE_REPEAT_LIST, MODE_REPEAT_ONE. Each mode stands for different playing orders.
    ...
    ![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/Play_Mode.jpg)
...
5. Upload the code. Click to Serial Monitor when “Done uploading” appears, you will find the order of songs is randomized on the list.
    ...
    ![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/Play_List.jpg)
...
1. This demo will show you how to play part of the songs from all songs in the SD card. Open the “addToList” example via the path: File --> Examples --> MusicPlayer --> addToList.
    ...
    ![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/Select_play.jpg)
...
1. Plug the Grove-Base Shield onto the Music shield, Connect the Grove socket of the Rotary and analog port 4 of the Base Shield with a Grove cable. You can change to the digital port as well. But don't forget to change the port number in the definition of the demo code at the same time.
    ...
    ![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/Music_shield_5.jpg)
...
![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/Music_shield_midi_demo.jpeg)
...
![](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/img/MIDIlist.gif)

Resources
---------

- [Music Shield V2.2 Eagle Files](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/res/Music_Shield_v2.2.zip)
- [Music Shield V2.2 Schematic.pdf](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/res/Music_Shield_v2.2_pdf.pdf)
- [VS1053 Datasheet](/https://github.com/SeeedDoc/WikiMigrationSync/raw/master/docs/assets/Music_Shield_V2.2/res/VS1053.pdf)
