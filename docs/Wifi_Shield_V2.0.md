...
surveyurl: https://www.research.net/r/Wifi_Shield_V2.0
sku: 113030008
---

![](/assets/Wifi_Shield_V2.0/img/Wifi_Shield_v2.jpg)
...
The shield is very well documented with our examples below and its [user manual](/assets/Wifi_Shield_V2.0/res/WiFly-RN-UM.pdf).

[![](/assets/common/Get_One_Now_Banner.png)](http://www.seeedstudio.com/depot/Wifi-Shield-V20-p-2505.html)
...
| Library File       | [Wifi Shield Library V1.0](/assets/Wifi_Shield_V2.0/res/WifiShield.zip) | [New Wifi Shield Library](https://github.com/Seeed-Studio/WiFi_Shield) | [New Wifi Shield Library](https://github.com/Seeed-Studio/WiFi_Shield) *the same as v1.2* |
...
![](/assets/Wifi_Shield_V2.0/img/Wifi_shield_v2_breakout.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi_shield_v1.1_pinout.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi_shield_v1.1_communicate.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi_shield_v1.1_front.png)
...
For a complete list of configuration commands, please see the RN-171 [Reference Guide](/assets/Wifi_Shield_V2.0/res/WiFly-RN-UM.pdf) starting on page 11.
...
If your access point's security type is WEP use *key* instead of *phrase* in the command above.
    ...
    2.  The access point's (internet router) phrase is the password you use to connect to it from your PC. In Windows you can find it as shown in the animated image below:
        ![](/assets/Wifi_Shield_V2.0/img/How_to_find_network_security_key_password.gif)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi-shield-led-control-serial-comm-window.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi-shield-simple-webserver-page.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi-shield-simple-webserver-arduino-serial-window-response.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi-shield-led-control-schematic.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi-shield-led-control-webpage.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi-shield-led-control-arduino-response.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi-shield-led-control-serial-comm-response.png)

*Arduino serial comm output when an HTTP request is sent to the shield.*

### Example 6: WiFi Shield and Android App

![](/assets/Wifi_Shield_V2.0/img/Androidapp-ethernet-shield-led-toggle.png)
...
Download the Android Studio project/source form this [link:](/assets/Wifi_Shield_V2.0/res/WiFiShieldLEDControl.zip "WiFiShieldLEDControl.zip")
...
Section 13 of the [WiFly manual](/assets/Wifi_Shield_V2.0/res/WiFly-RN-UM.pdf) teaches you different ways to connect to a web server, but in all cases we need to specify the name of the server (or IP address if the server does not have a domain name), and then the data we wish to send.
...
![](/assets/Wifi_Shield_V2.0/img/Open-weather-api-json-string.png)
...
![](/assets/Wifi_Shield_V2.0/img/Tcp-arduino-serial-comm.png)
...
![](/assets/Wifi_Shield_V2.0/img/Realterm-display-tab.png)
...
![](/assets/Wifi_Shield_V2.0/img/Realterm-port-tab.png)
...
![](/assets/Wifi_Shield_V2.0/img/Realterm-send-tab.png)
...
![](/assets/Wifi_Shield_V2.0/img/Wifi-shield-adhoc-mode-hardware-connection.png)
...
To learn more about adhoc mode check out the [WiFly RN User Manual](/assets/Wifi_Shield_V2.0/res/WiFly-RN-UM.pdf) section 16 "Adhoc Networking Mode"

Resources
---------

-   [WiFi Shield V2.0 Eagle Files](/assets/Wifi_Shield_V2.0/res/Wifi_Shield_v2.0.zip)
-   [Schematic PDF](/assets/Wifi_Shield_V2.0/res/Wifi_shield_v2_schematic.pdf)
-   [RN-171 Datasheet](/assets/Wifi_Shield_V2.0/res/WiFly-RN-171.pdf)
-   [Wifi Shield Library](https://github.com/Seeed-Studio/WiFi_Shield)
-   [WiFi Module User Manual](/assets/Wifi_Shield_V2.0/res/WiFly-RN-UM.pdf) *-- This is where you'll find all the commands for the RN-171 module in the shield.*
